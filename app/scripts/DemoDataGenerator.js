(function (angular, _) {
	...
	function getHealthDemoData() {
		return {
			'IsHealthy': false,
			'Unhealthy': {
				'DatabaseCheck': 'EXCEPTION: NullReferenceException - Object reference not set to an'+
				'instance of an object.\r\n    NullReferenceException: Object reference not set to an instance' +
				' of an object.\r\n    at Metrics.Samples.HealthChecksSample.DatabaseHealthCheck.Check() ' +
				'in HealthChecksSample.cs:line ' +
				'24\r\n    at Metrics.Core.HealthCheck.Execute() in HealthCheck.cs:line 50\r\n',
				'DiskSpace': 'Not enough disk space: 100kb'
			},
			'Healthy': {
